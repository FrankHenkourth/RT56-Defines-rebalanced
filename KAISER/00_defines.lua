...
NDiplomacy = {
	...
	VOLUNTEERS_DIVISIONS_REQUIRED = 24,				-- This many divisons are required for the country to be able to send volunteers.
...
NCountry = {
	...
	POLITICAL_POWER_UPPER_CAP = 5000.0,				-- Max amount of political power country should have
	...
	BASE_MAX_COMMAND_POWER = 1680.0,					-- base value for maximum command power
